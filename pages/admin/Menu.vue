      ...
      <div class="bg-white p-6 rounded shadow-lg w-96">
        ...
        <form @submit.prevent="showEditModal ? updateMenuItem() : createMenuItem()">
          ...
          <div class="mb-4">
            ...
            <img v-if="imagePreview" :src="imagePreview" alt="Aper̤u" class="mt-2 w-24 h-24 object-cover rounded" />
...
=======
      this.error = '';
      // Afficher l'aper̤u de l'image existante lors de la modification
